...
class _$TempTodoItemDataTearOff {
  ...
  _TempTodoItemData call({String title = '', String comment = ''}) {
...
abstract class $TempTodoItemDataCopyWith<$Res> {
  ...
  $Res call({String title, String comment});
}
...
class _$_TempTodoItemData implements _TempTodoItemData {
  _$_TempTodoItemData({this.title = '', this.comment = ''});
  ...
  @override
  String toString() {
    return 'TempTodoItemData(title: $title, comment: $comment)';
  }
...
abstract class _TempTodoItemData implements TempTodoItemData {
  factory _TempTodoItemData({String title, String comment}) =
      _$_TempTodoItemData;
